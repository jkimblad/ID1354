<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>../application/assets/css/reset.css">
        <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>../application/assets/css/mystyles.css">
    </head>
    <body>
        <ul class="navbar">
            ...
            <li class="navbar-item-right"><a class="navbar-link" href="<?php echo base_url(); ?>login">User</a></li>
        </ul>
